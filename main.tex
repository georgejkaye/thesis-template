...
\ifthenelse{\boolean{shade-envs}}{%
  ...
  % Now we set the shading using the tcolorenvironment package.
  %
  ...
  \newcommand{\colorenvironment}[2]{%
      \tcolorboxenvironment{#1}{shadedenv={#2}}
      \addtotheorempreheadhook[#1]{\tikzcdset{background color=#2}}
  }
  %
  \colorenvironment{theorem}{ShadeOfPurple}
  \colorenvironment{lemma}{ShadeOfPurple}
  \colorenvironment{proposition}{ShadeOfPurple}
  \colorenvironment{corollary}{ShadeOfPurple}
  \colorenvironment{definition}{ShadeOfYellow}
  \colorenvironment{example}{ShadeOfGreen}
  \colorenvironment{remark}{ShadeOfBrown}
  \colorenvironment{proof}{ShadeOfGray}
